#!/bin/bash
# Lockphish v1.1
# Coded by: github.com/Avenge-hacker/lockphish
# Twitter: @Avengehacker
...
printf " \n\e[1;77m coded by: github.com/Avenge-hacker/lockphish\e[0m \n"
printf " \e[1;77mEmail: avengehacker05@gmail.com\e[1;77m\e[0m"
